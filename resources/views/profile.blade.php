        ...
        <div class="user-profile-div">
            ...
            <div class="media user-profile-data">
                ...
                <div class="media-body user-profile-body">
                    ...
                    <br>
                    <button type="button" data-name="{{$userdata->name}}" data-email="{{$userdata->email}}"  data-current="{{$userdata->current_job}}" data-previous="{{$userdata->previous_job}}" class="btn btn-default edit-button-profile" data-toggle="modal" data-target="#myModal">Edit Profile</button>
                    <button type="button" class="btn btn-default post-button-profile" data-toggle="modal" data-target="#create-post">Suggest Post</button>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit"    class="btn btn-default user-form-save" >Save Changes</button>
                    ...
                    <!--/// end edit model -->
                    <!-- post Modal -->
                    <div class="modal fade" id="create-post" role="dialog">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h2 class="modal-title">Suggestion Form</h2>
                                </div>
                                <div class="modal-body">
                                    <!--////////////////////////////////////-->
                                    <form class="form-horizontal" role="form" >
                                        {{csrf_field()}}
                                        <div class="form-group">
                                            <label for="">Suggest something For Specified Topic.</label>
                                            <p class="error text-center alert alert-danger hidden"></p>
                                            <textarea class="form-control" rows="4" name="content2" id="content2" placeholder="Suggest Something..." required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="topic_name" name="topic_name" value="" placeholder="Write Topic" required>
                                        </div>
                                    </form>
                                    <!--////////////////////////-->
                                </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="media-heading">
                                                ...
                                                <h4 ><a href="/profile">{{$post->name}}</a><span class="sug4">suggested at</span><a class="topic_link" href="/topic/{{$post->topic_name}}"> {{$post->topic_name}}</a></h4>
                                            </div>
                                            <p>{{$post->content}}</p>
                                        </div>
                                    ...
                                    <li >
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <h3 class="media-heading"><a class="topic_link" href="topic/{{$topic->topic_name}}">#{{$topic->topic_name}}</a></h3>
                                                <span class="sug5">{{count($topics)}} suggestions </span>
                                                <!--<button class="btn btn-default follow-button-following">interest</button>-->
                                                <button id="interested-button-head" data-id="{{$topic->interestings}}" data-name="{{$topic->topic_name}}" class="btn btn-default interested-button">Interested</button>
                                            </div>
                                        </div>
                                    </li>
                                    <hr>
